...
void load_device_properties() {
    property_override("ro.build.fingerprint", "google/raven/raven:12/SQ1D.220505.002/8353555:user/release-keys");
    property_override("ro.build.description", "raven-user 12 SQ1D.220505.002 8353555 release-keys");
